...
export const sampleData: AppDataExport = {
  ...
  applications: [
    ...
    },
    {
      ...
      salaryRange: "28-42K",
      jdText:
        "负责 AI 协作工具 Web 端开发，要求 React、TypeScript、LLM 应用、流式输出、复杂表单、状态管理、工程化和性能优化经验。",
      status: "applied",
      appliedAt: dateOffset(-5),
      nextFollowUpAt: dateOffset(1),
      resumeVersionId: "sample-resume-1",
      notes: "需要突出 AI Coding 和复杂前端工程化经验。",
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      salaryRange: "35-50K",
      jdText:
        "负责跨境电商移动端架构升级，要求 Android、Flutter、性能优化、稳定性治理、动态化、支付链路和海外合规经验。",
      status: "no_response",
      appliedAt: dateOffset(-12),
      nextFollowUpAt: dateOffset(-1),
      resumeVersionId: "sample-resume-1",
      notes: "岗位薪资不错，但 12 天未回复，适合复盘渠道效率。",
      createdAt: now,
      updatedAt: now,
    },
    {
      id: "sample-app-6",
      companyName: "数据基础设施公司",
      jobTitle: "全栈工程师",
      channel: "拉勾",
      city: "上海",
      remoteType: "remote",
      salaryRange: "24-36K",
      jdText:
        "负责数据平台全栈开发，要求 React、Node.js、TypeScript、可视化图表、权限系统、工程化和云原生基础知识。",
      status: "rejected",
      appliedAt: dateOffset(-9),
      nextFollowUpAt: "",
      resumeVersionId: "sample-resume-2",
      notes: "简历和岗位后端要求匹配度不足，后续需要补强全栈项目表达。",
      createdAt: now,
      updatedAt: now,
    },
  ],
